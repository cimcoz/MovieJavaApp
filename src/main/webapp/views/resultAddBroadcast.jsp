...
<title>Added movie page</title>
</head>
<body>
	Broadcast for movie: ${movieName} was added into DB for date: ${broadcast.date} in screen room name: ${broadcast.screenRoom.name}<br><br>
	<br>
